...
//Так как в условии неопредены метод интервал значений эл-тов массива,
//то определяем задаем массив случайными вещественными значениями в диапазоне [-100, 100]
